        ...
        render_thread::{
            states::{
                gpu_state::{
                    ...
                    material::Material,
                    camera::{ViewProjectionUniformMatrixCache, CameraStorage},
                    shapes::square::{SQUARE_INDEX, SQUARE_VERTICES},
                    managers::{
                        texture_atlas_manager::TextureAtlasManager,
                        sampler_manager::{SamplerManager, SamplerName},
                        bind_group_layout_manager::{BindGroupLayoutManager, BindGroupLayoutName},
                        bind_group_manager::{BindGroupManager, BindGroupName},
                        render_pipeline_manager::{RenderPipelineManager, RenderPipelineName},
...
impl GPUState {
    pub async fn new(window: Arc<Window>) -> Self {
        ...
        let camera_uniform_matrix = ViewProjectionUniformMatrixCache::default(); 
        ...
        material_manager.add_material(0, ant_material);
        material_manager.add_material(1, pig_material);
